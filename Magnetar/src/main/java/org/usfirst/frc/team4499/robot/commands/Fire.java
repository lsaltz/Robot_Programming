...
public class Fire extends CommandGroup {
    ...
    public Fire() {
    	...
    	addSequential(new Set_Piston(RobotMap.catapultRelease, RobotMap.releaseClosed, Robot.catapultSubsystem));
    	addSequential(new Set_Piston(RobotMap.intake, RobotMap.intakeIn, Robot.subsystem));
